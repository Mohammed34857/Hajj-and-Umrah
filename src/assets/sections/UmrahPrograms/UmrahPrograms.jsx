  ...
  return (
    <div id='UmrahPrograms' className='Umrah-programs'>
      <p className='Umrah-programs-paragraph'> برامج العمرة : <br /> 
         نحرص على تقديم أفضل (برامج العمرة)
          ذات الخدمات الفائقة مع العناية بأدق التفاصيل والجوانب؛ لنعبّر عن تقديرنا
           العميق لعملائنا الكرام وتزويدهم بتجربة ثرية لا مثيل لها وتتضمن 
           (برامج العمرة) العديد من الخدمات الخاصة مثل الإقامة في فنادق فاخرة، وتوفير المواصلات الراقية بين المشاعر المقدسة، للاستمتاع برحلة عمرة استثنائية خلال سفركم وإقامتكم في جوار الحرمين الشريفين لأنكم تستحقون الأفضل.</p>
